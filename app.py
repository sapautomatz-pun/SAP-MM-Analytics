# app.py
# SAP Automatz – Procurement Analytics v43_Pro_Dashboard
# Features:
#  - Secure access key validation
#  - KPI tiles (colored summary boxes)
#  - AI Insights (OpenAI or fallback)
#  - Charts: Currency, Vendors, Materials, Trend
#  - PDF report with cover, insights, charts, and risk section
...
kpi1.metric("💰 Total Spend", f"{k['total_spend']:,.2f} {k['dominant']}")
kpi2.metric("🏢 Top Vendors", len(k["top_v"]))
kpi3.metric("⚠️ Risk Score", f"{risk['score']:.0f} ({risk['band']})")
